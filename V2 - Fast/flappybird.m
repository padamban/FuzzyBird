...
SET.XTubeOffsetRange = 30;     % default = 0
...
function CMDENV_report()
    ...
    PRINT_print({ 'INPUT.xGapFront', 'INPUT.yGapCenter','INPUT.yGapCenterNext','INPUT.yGapCenterDelta',  'CMD.jumpWait', 'GAME.CurrentFrameNo', 'CMD.currTime', 'CMD.timeToJump', 'INPUT.xPrevGapFront', 'INPUT.yAltitude', 'INPUT.yAdjGapCenterPos'}, TEXT.th2);
...
%     input = [INPUT.yGapCenter, INPUT.yAltitude, INPUT.xGapFront, INPUT.yGapCenterNext, INPUT.yGapCenterDelta];
    input = [INPUT.yAdjGapCenter,  INPUT.yGapCenterDelta, INPUT.yAltitude, INPUT.xPrevGapFront];
